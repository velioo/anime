...
<div id="user-bar" style="background-image:url('<?php if($results['cover_image'] != "") echo asset_url() . "user_cover_images/" . $results['cover_image'] . "?rand={$random_num}"; else echo asset_url() . "user_cover_images/Default.jpg"?>'); ">
	<div class="container-fluid top-container">		
		...
		<div id="user_image_div">
			<img src="<?php echo asset_url() . "user_profile_images/" . $results['profile_image'] ."?rand={$random_num};"?>" onerror="this.src='<?php echo asset_url()."user_profile_images/Default.png"?>'"  alt="Image" id="user_image">
